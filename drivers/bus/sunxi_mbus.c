...
#else
static SENSOR_DEVICE_ATTR(pmu_eink0_ddr, S_IRUGO, mbus_show_value, NULL,
			  MBUS_PMU_EINK0);
static SENSOR_DEVICE_ATTR(pmu_edma_ddr, S_IRUGO, mbus_show_value, NULL,
			  MBUS_PMU_EDMA);
static SENSOR_DEVICE_ATTR(pmu_mahb_ddr, S_IRUGO, mbus_show_value, NULL,
			  MBUS_PMU_MAHB);
#endif
