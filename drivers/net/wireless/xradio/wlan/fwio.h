...
#define XR819_BOOTLOADER    ("/lib/firmware/b288wifi/boot_B100.bin")
#define XR819_FIRMWARE      ("/lib/firmware/b288wifi/fw_B100.bin")
#define XR819_SDD_FILE      ("/lib/firmware/b288wifi/sdd_B100.bin")
#else
#define XR819_BOOTLOADER    ("boot_B100.bin")
#define XR819_FIRMWARE      ("fw_B100.bin")
#define XR819_SDD_FILE      ("sdd_B100.bin")
#endif
