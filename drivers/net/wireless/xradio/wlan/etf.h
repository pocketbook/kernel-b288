...
//#define XR819_ETF_FIRMWARE   ("/system/etc/firmware/etf_B100.bin")
#define XR819_ETF_FIRMWARE   ("/lib/firmware/b288wifi/etf_B100.bin")
#else
#define XR819_ETF_FIRMWARE   ("etf_B100.bin")
#endif
