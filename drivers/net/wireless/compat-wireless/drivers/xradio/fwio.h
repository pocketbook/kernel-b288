...
#define XR819_BOOTLOADER    ("/opt/firmware/boot_xr819.bin")//("/system/etc/firmware/boot_xr819.bin")
#define XR819_FIRMWARE      ("/opt/firmware/fw_xr819.bin")//("/system/etc/firmware/fw_xr819.bin")
#define XR819_SDD_FILE      ("/opt/firmware/sdd_xr819.bin")//("/system/etc/firmware/sdd_xr819.bin")
#else
