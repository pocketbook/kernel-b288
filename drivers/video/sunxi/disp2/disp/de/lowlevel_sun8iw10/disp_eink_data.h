...
#define         EINK_PANEL_W            (1024)			//800 //1024
#define         EINK_PANEL_H            (758)			//600 //758
...
#define         EINK_FEL                12
#define         EINK_VYNC               (EINK_FSL+EINK_FBL+EINK_FEL)        //21

#define         EINK_LCD_W              (EINK_LDL+EINK_HYNC)		//256+58=314
#define         EINK_LCD_H              (EINK_FDL+EINK_VYNC)		//758+21=779

#define         EINK_WF_WIDTH           EINK_LCD_W		//314
#define         EINK_WF_HEIGHT          EINK_LCD_H		//779
...
extern int init_eink_ctrl_data_8(void *wavedata_buf, struct eink_timing_param *eink_timing_info);
extern int init_eink_ctrl_data_16(void *wavedata_buf, struct eink_timing_param *eink_timing_info);
#endif
