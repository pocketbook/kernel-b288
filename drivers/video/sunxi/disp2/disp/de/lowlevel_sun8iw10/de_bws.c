...
{
	XLOG1("de_bws_set_reg_base %d,%d,%08x\n", sel, chno, (unsigned long)base);
...
int de_bws_init(unsigned int sel, unsigned int chno, uintptr_t reg_base)
{
	...
	XLOG1("de_bws_init: sel %d, bws_base[%d]=0x%p\n", sel, chno, (void*)base);
...
{
	XLOG1("de_bws_set_size %d,%d,%d,%d\n", sel, chno, width, height);
...
{
	XLOG1("de_bws_set_size %d,%d,%d (%d,%d,%d,%d)\n", sel, chno, win_enable, window.x, window.y, window.w, window.h);
						...
						unsigned int slope0, unsigned int slope1, unsigned int slope2, unsigned int slope3)
{
	...
	XLOG1("de_bws_set_para(1) %d,%d %d,%d,%d,%d, %d,%d,%d,%d\n", sel, chno, min, black, white, max, slope0, slope1, slope2, slope3);
						...
						unsigned int slope0, unsigned int slope1, unsigned int slope2, unsigned int slope3)
{
	...
	XLOG1("de_bws_set_para(2) %d,%d %d,%d,%d,%d, %d,%d,%d,%d\n", sel, chno, min, black, white, max, slope0, slope1, slope2, slope3);
...
int de_bws_tasklet(unsigned int screen_id, unsigned int chno, unsigned int frame_cnt)
{
	...
	XLOG1("de_bws_tasklet %d,%d,%d\n", screen_id, chno, frame_cnt);
