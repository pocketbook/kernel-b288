...
//int disp_al_eink_start_decode(unsigned int disp, phys_addr_t new_idx_addr, phys_addr_t wav_data_addr, struct epdc_init_param *param);
...
int disp_al_get_waveform_data(unsigned int disp, int wf, int updmode, unsigned int temp, unsigned int *total_frames, phys_addr_t *wf_buf);
