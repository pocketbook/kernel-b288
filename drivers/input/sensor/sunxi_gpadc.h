...
//#define GP_INTC_REG		(0x1C) /* GPADC interrupt config register */
//#define GP_INTS_REG		(0x20) /* GPADC interrupt status register */
//#define GP_CH0_CMP_DATA_REG		(0x24) /* GPADC channal 0 compare data register */
//#define GP_CH1_CMP_DATA_REG		(0x28) /* GPADC channal 1 compare data register */
//#define GP_CH2_CMP_DATA_REG 	(0x2C) /* GPADC channal 2 compare data register */
//#define GP_CH3_CMP_DATA_REG 	(0x30) /* GPADC channal 3 compare data register */
//#define GP_CH0_DATA_REG 	(0x34) /* GPADC channal 0 data register */
//#define GP_CH1_DATA_REG 	(0x38) /* GPADC channal 1 data register */
//#define GP_CH2_DATA_REG 	(0x3C) /* GPADC channal 2 data register */
//#define GP_CH3_DATA_REG 	(0x40) /* GPADC channal 3 data register */
